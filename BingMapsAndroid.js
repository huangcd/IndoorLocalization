...
var BingMapsAndroid = new function(){
	...
	this.LoadMap = function(mapId){
		...
		if (_bingMapKey === null || _bingMapKey === "") {
		    _bingMapKey = "Ao7O0zQ94bMWRCfUbKw213ZIp3iqUhRKAp-oQu0M0Ilfg-UHbyoD_p5H31Z6VPyJ";
		}
	...
	this.SetTileSource = function(uriPattern, opacity) {
	    // Create the tile layer source
	    var tileSource = new Microsoft.Maps.TileSource({uriConstructor:uriPattern});

	    // Construct the layer using the tile source
        var tileLayer= new Microsoft.Maps.TileLayer({ mercator: tileSource, opacity: opacity });
